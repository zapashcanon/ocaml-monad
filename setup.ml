...
(* OASIS_START *)
(* DO NOT EDIT (digest: 083910936b88250c850f82d53be13bbf) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "monadlib";
                      lib_findlib_name = None;
                      lib_findlib_containers = []
                   });
               Doc
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "t?t\153\251\t\b\255!\023\193#\150\248\178\214";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
